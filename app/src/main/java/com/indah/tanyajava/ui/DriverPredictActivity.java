...
import com.indah.tanyajava.ml.ConvertedModel;
...
public class DriverPredictActivity extends AppCompatActivity {

    Button camera;
    ImageView imageView, button_back;
    TextView result;
    int imageSize = 64;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_driver_predict);
